...
The scripts ran from the session scratchpad; this condensed form is enough to regenerate every [EMP] fact:
...
11. **HANDOFF quote.** The doc gave "does nothing (TEXT compared with INTEGER)" as a quote, but it was a paraphrase. It is now quoted verbatim from `HANDOFF.md:94`.
12. **The "167,210-digit KGH value"** was attributed to HANDOFF. It is a synthetic `47^100000` stress vector (`JOURNAL.md:772`, `README.md:120`). The longest real `kgh_hash` is 20,699 digits (sechost).
