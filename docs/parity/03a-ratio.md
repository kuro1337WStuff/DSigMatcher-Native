...
The scratch files are in `<temp>\claude\C--Users-Loki\229334b0-3f04-4430-9a2d-fa45ecf15f33\scratchpad\`. Python bytecode writing was disabled, and `git status` in diaphora-ref stayed clean.
...
An adversarial verification pass checked this spec against `<diaphora-ref>` (`3.4.2-4-g621ec26`, `git status` clean), the stdlib `difflib.py` of Python 3.13.12, the SQLite amalgamation/DLLs and the exporter `diaphora_ida.py`. The probe scripts are in `<temp>\claude\C--Users-Loki\229334b0-3f04-4430-9a2d-fa45ecf15f33\scratchpad\v03a\`: `probes1.py`, `relaxed2.py`, `misc.py`, `mdprobe.py`, `dllprobe.py`, `onedll.py`, `mdperm.py`, plus copies of the extractor's `harness.py`/`pathb.py`/`relaxed.py`, re-run in isolation.
...
7. **§6.4:**
   ...
   - Fixed the vague `crossboss/...` citation to an absolute path with function line numbers.
