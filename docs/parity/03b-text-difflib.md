...
- The scratch scripts are in `<temp>\claude\C--Users-Loki\229334b0-3f04-4430-9a2d-fa45ecf15f33\scratchpad\spec03b\` (`port.py`, `hand.py`, `t1.py`-`t6.py`, `vec.py`, `tc.cpp`). They are session scratch, not part of the repo, and may be deleted. Each one can be rebuilt from this document.
...
Scratch directory: `<temp>\claude\C--Users-Loki\229334b0-3f04-4430-9a2d-fa45ecf15f33\scratchpad\v03b\`.
