...
CREATE TABLE functions (
                          ...
                          microcode_spp text,
                          export_time real);
INSERT INTO "functions" VALUES(1,'sub_501100','5247232',4,3,1,1,32,8,'["push", "mov", "add", "add", "add", "add", "pop", "ret"]','[]',NULL,1,'9',NULL,'sub_501100','4f27a1d58de2b7b44ebe79488e6bb499',NULL,0,NULL,NULL,0,'push rbp
mov rbp, rsp
add eax, 7
add eax, 8
add eax, 9
add eax, 10
pop rbp
ret',NULL,NULL,NULL,1,0,'5247232','[[0]]','2','push rbp
mov rbp, rsp
add eax, 7
add eax, 8
add eax, 9
add eax, 10
pop rbp
ret',NULL,'34','[]','d78f0ed9114983ed1affb76300609ba7',232,'0','[]',0,'5247232','[]','0',NULL,NULL,NULL,NULL,'1',0.001);
INSERT INTO "functions" VALUES(2,'sub_501200','5247488',4,3,1,1,32,8,'["push", "mov", "add", "add", "add", "add", "pop", "ret"]','[]',NULL,1,'9',NULL,'sub_501200','e26d758e6fe160839518809b92f8fdfc',NULL,0,NULL,NULL,0,'push rbp
mov rbp, rsp
add eax, 14
add eax, 15
add eax, 16
add eax, 17
pop rbp
ret',NULL,NULL,NULL,1,0,'5247488','[[0]]','2','push rbp
mov rbp, rsp
add eax, 14
add eax, 15
add eax, 16
add eax, 17
pop rbp
ret',NULL,'34','[]','f08c981f2b71b202d04ca3c7035454e5',488,'0','[]',0,'5247488','[]','0',NULL,NULL,NULL,NULL,'1',0.002);
INSERT INTO "functions" VALUES(3,'sub_501300','5247744',4,3,1,1,32,8,'["push", "mov", "add", "add", "add", "add", "pop", "ret"]','[]',NULL,1,'9',NULL,'sub_501300','8794cb26fcd80778c6c7f8c8d5be5f48',NULL,0,NULL,NULL,0,'push rbp
mov rbp, rsp
add eax, 21
add eax, 22
add eax, 23
add eax, 24
pop rbp
ret',NULL,NULL,NULL,1,0,'5247744','[[0]]','2','push rbp
mov rbp, rsp
add eax, 21
add eax, 22
add eax, 23
add eax, 24
pop rbp
ret',NULL,'34','[]','a59ac60199e4456b8f506b9e842bfb05',744,'0','[]',0,'5247744','[]','0',NULL,NULL,NULL,NULL,'1',0.003);
INSERT INTO "functions" VALUES(4,'sub_501400','5248000',4,3,1,1,32,8,'["push", "mov", "add", "add", "add", "add", "pop", "ret"]','[]',NULL,1,'9',NULL,'sub_501400','d7940bc759b32217c5c520d085b44c03',NULL,0,NULL,NULL,0,'push rbp
mov rbp, rsp
add eax, 28
add eax, 29
add eax, 30
add eax, 31
pop rbp
ret',NULL,NULL,NULL,1,0,'5248000','[[0]]','2','push rbp
mov rbp, rsp
add eax, 28
add eax, 29
add eax, 30
add eax, 31
pop rbp
ret',NULL,'34','[]','f6a5d6386f273bd40b0f4955fcc87be6',0,'0','[]',0,'5248000','[]','0',NULL,NULL,NULL,NULL,'1',0.004);
INSERT INTO "functions" VALUES(5,'sub_501500','5248256',4,3,1,1,32,8,'["push", "mov", "add", "add", "add", "add", "pop", "ret"]','[]',NULL,1,'9',NULL,'sub_501500','2f320932dc6ecf7dd1300c8a82c7193e',NULL,0,NULL,NULL,0,'push rbp
mov rbp, rsp
add eax, 35
add eax, 36
add eax, 37
add eax, 38
pop rbp
ret',NULL,NULL,NULL,1,0,'5248256','[[0]]','2','push rbp
mov rbp, rsp
add eax, 35
add eax, 36
add eax, 37
add eax, 38
pop rbp
ret',NULL,'34','[]','12734b4be21161ff811babed9edc7dd2',256,'0','[]',0,'5248256','[]','0',NULL,NULL,NULL,NULL,'1',0.005);
INSERT INTO "functions" VALUES(6,'sub_501600','5248512',4,3,1,1,32,8,'["push", "mov", "add", "add", "add", "add", "pop", "ret"]','[]',NULL,1,'9',NULL,'sub_501600','e2bcb9d45d50f43f2bf86870f2238f6c',NULL,0,NULL,NULL,0,'push rbp
mov rbp, rsp
add eax, 42
add eax, 43
add eax, 44
add eax, 45
pop rbp
ret',NULL,NULL,NULL,1,0,'5248512','[[0]]','2','push rbp
mov rbp, rsp
add eax, 42
add eax, 43
add eax, 44
add eax, 45
pop rbp
ret',NULL,'34','[]','8540bf716b7c998a561b9c573a5a590f',512,'0','[]',0,'5248512','[]','0',NULL,NULL,NULL,NULL,'1',0.006);
