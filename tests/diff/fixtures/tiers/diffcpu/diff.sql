...
CREATE TABLE functions (
                          ...
                          microcode_spp text,
                          export_time real);
INSERT INTO "functions" VALUES(1,'sub_501000','5246976',4,3,1,1,28,7,'["push", "mov", "mov", "add", "imul", "pop", "retn"]','[]',NULL,1,'9',NULL,'sub_501000','7b7cc9cb3289b6c4ffd925756245a966',NULL,0,NULL,NULL,0,'push rbp
mov rbp, rsp
mov eax, [rcx+8]
add eax, 3
imul eax, eax
pop rbp
retn',NULL,NULL,NULL,1,0,'5246976','[[0]]','2','push rbp
mov rbp, rsp
mov eax, [rcx+8]
add eax, 3
imul eax, eax
pop rbp
retn',NULL,'34','[]','6ccfa191dd07778b4d2651ffc6023729',976,'0','[]',0,'5246976','[]','0',NULL,NULL,NULL,NULL,'1',0.001);
INSERT INTO "functions" VALUES(2,'sub_501100','5247232',3,2,1,1,28,7,'["xor", "loc_a:", "add", "add", "dec", "jnz", "retn"]','[]',NULL,1,'7',NULL,'sub_501100','0339cf8fd04dc459512ba21eaa93cd7f',NULL,0,NULL,NULL,0,'xor eax, eax
loc_a:
add eax, ecx
add eax, 1
dec ecx
jnz short loc_a
retn',NULL,NULL,NULL,1,2,'5247232','[[0]]','2','xor eax, eax
loc_a:
add eax, ecx
add eax, 1
dec ecx
jnz short loc_a
retn',NULL,'33','[]','a53aa03e7a8edd6c5fdc032ecb43dc0e',232,'0','[]',0,'5247232','[]','0',NULL,NULL,NULL,NULL,'1',0.002);
INSERT INTO "functions" VALUES(3,'sub_501200','5247488',2,1,1,1,24,6,'["rdtsc", "shl", "or", "mov", "xor", "retn"]','[]',NULL,1,'5',NULL,'sub_501200','ca7221ff43f2022b5aa13d05ffdf597c',NULL,0,NULL,NULL,0,'rdtsc
shl rdx, 20h
or rax, rdx
mov [rcx], rax
xor eax, eax
retn',NULL,NULL,NULL,1,0,'5247488','[[0]]','2','rdtsc
shl rdx, 20h
or rax, rdx
mov [rcx], rax
xor eax, eax
retn',NULL,'32','[]','e52416dc1481cd6262bd6bf4c412b4bf',488,'0','[]',0,'5247488','[]','0',NULL,NULL,NULL,NULL,'1',0.003);
...
INSERT INTO "program" VALUES(1,'10','{"10": 1}','ARM','0000000000000000000000000000000a');
...
INSERT INTO "sqlite_stat1" VALUES('functions','idx_27','3 3 3 3');
INSERT INTO "sqlite_stat1" VALUES('functions','idx_26','3 3 3');
INSERT INTO "sqlite_stat1" VALUES('functions','idx_25','3 3');
INSERT INTO "sqlite_stat1" VALUES('functions','idx_24','3 3');
...
INSERT INTO "sqlite_stat1" VALUES('functions','idx_16','3 2');
...
INSERT INTO "sqlite_stat1" VALUES('functions','idx_10','3 3 1');
INSERT INTO "sqlite_stat1" VALUES('functions','idx_9','3 3 3');
INSERT INTO "sqlite_stat1" VALUES('functions','idx_8','3 3');
INSERT INTO "sqlite_stat1" VALUES('functions','idx_7','3 1 1 1');
INSERT INTO "sqlite_stat1" VALUES('functions','idx_6','3 2 1 1');
INSERT INTO "sqlite_stat1" VALUES('functions','idx_5','3 1 1 1 1 1 1 1 1');
