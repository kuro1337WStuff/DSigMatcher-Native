...
CREATE TABLE functions (
                          ...
                          microcode_spp text,
                          export_time real);
INSERT INTO "functions" VALUES(1,'func_same','4198400',4,3,1,1,28,7,'["push", "mov", "mov", "add", "imul", "pop", "retn"]','[]',NULL,1,'9',NULL,'func_same','7b7cc9cb3289b6c4ffd925756245a966',NULL,0,NULL,NULL,0,'push rbp
mov rbp, rsp
mov eax, [rcx+8]
add eax, 3
imul eax, eax
pop rbp
retn',NULL,NULL,NULL,1,0,'4198400','[[0]]','2','push rbp
mov rbp, rsp
mov eax, [rcx+8]
add eax, 3
imul eax, eax
pop rbp
retn',NULL,'34','[]','6ccfa191dd07778b4d2651ffc6023729',400,'0','[]',0,'4198400','[]','0',NULL,NULL,NULL,NULL,'1',0.001);
INSERT INTO "functions" VALUES(2,'func_loop','4198656',3,2,1,1,28,7,'["xor", "loc_a:", "add", "dec", "jnz", "mov", "retn"]','[]',NULL,1,'7',NULL,'func_loop','0598913ac56116846758df8e2e9c9a26',NULL,0,NULL,NULL,0,'xor eax, eax
loc_a:
add eax, ecx
dec ecx
jnz short loc_a
mov edx, eax
retn',NULL,NULL,NULL,1,2,'4198656','[[0]]','2','xor eax, eax
loc_a:
add eax, ecx
dec ecx
jnz short loc_a
mov edx, eax
retn',NULL,'33','[]','7bedb0d1c5a2562db74df1e51672d8fa',656,'0','[]',0,'4198656','[]','0',NULL,NULL,NULL,NULL,'1',0.002);
INSERT INTO "functions" VALUES(3,'func_alone','4198912',2,1,1,1,20,5,'["mov", "cpuid", "mov", "mov", "retn"]','[]',NULL,1,'5',NULL,'func_alone','126e81bb326846f23d581559d4679f4a',NULL,0,NULL,NULL,0,'mov eax, 1
cpuid
mov [rcx], eax
mov [rcx+4], ebx
retn',NULL,NULL,NULL,1,0,'4198912','[[0]]','2','mov eax, 1
cpuid
mov [rcx], eax
mov [rcx+4], ebx
retn',NULL,'32','[]','0d4202f43b317879303bc73289ba8ee1',912,'0','[]',0,'4198912','[]','0',NULL,NULL,NULL,NULL,'1',0.003);
