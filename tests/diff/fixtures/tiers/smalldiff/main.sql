...
CREATE TABLE functions (
                          ...
                          microcode_spp text,
                          export_time real);
INSERT INTO "functions" VALUES(1,'low_a','4198400',3,2,1,1,24,6,'["push", "mov", "add", "imul", "pop", "retn"]','["CreateFileW", "ReadFile", "CloseHandle"]',NULL,1,'7',NULL,'low_a','87c94b71864f7f2d154c898cfa835647',NULL,0,NULL,NULL,0,'push rbp
mov eax, 1
add eax, 2
imul eax, 3
pop rbp
...
imul eax, 3
pop rbp
retn',NULL,'311','[]','9f80333937e7102390dc5dcf7e2d4dd2',400,'1.25','[]',0,'4198400','[]','k1',NULL,NULL,NULL,NULL,'1',0.001);
INSERT INTO "functions" VALUES(2,'weak_a','4198656',3,2,1,1,24,6,'["push", "mov", "add", "imul", "pop", "retn"]','["HeapAlloc", "HeapFree", "GetProcessHeap"]',NULL,1,'7',NULL,'weak_a','f556ce73938f4aaf4ebcc0a2f68010ec',NULL,0,NULL,NULL,0,'push rbp
mov ecx, 1
add ecx, 2
imul ecx, 3
pop rbp
retn',NULL,NULL,NULL,1,0,'4198656','[[0]]','2','push rbp
mov ecx, 1
add ecx, 2
imul ecx, 3
pop rbp
retn',NULL,'321','[]','31a1857faef4715bb2c06356af6234c7',656,'2.25','[]',0,'4198656','[]','k2',NULL,NULL,NULL,NULL,'1',0.002);
INSERT INTO "functions" VALUES(3,'half_a','4198912',3,2,1,1,24,6,'["push", "mov", "add", "imul", "pop", "retn"]','["lstrlenW", "lstrcpyW"]',NULL,1,'7',NULL,'half_a','6dc7ca5ebfcecd19fff74fe3325c83a7',NULL,0,NULL,NULL,0,'push rbp
mov esi, 1
add esi, 2
imul esi, 3
pop rbp
retn',NULL,NULL,NULL,1,0,'4198912','[[0]]','2','push rbp
mov esi, 1
add esi, 2
imul esi, 3
pop rbp
retn',NULL,'331','[]','661e3ca0a0fb4576c62874a43b013157',912,'3.25','[]',0,'4198912','[]','k3',NULL,NULL,NULL,NULL,'1',0.003);
