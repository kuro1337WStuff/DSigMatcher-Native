...
CREATE TABLE functions (
                          ...
                          microcode_spp text,
                          export_time real);
INSERT INTO "functions" VALUES(1,'func_1','4096',4,3,1,1,32,8,'["push", "mov", "mov", "imul", "add", "xor", "pop", "retn"]','[]',NULL,1,'9',NULL,'func_1','95fa494b53fdd815283c84f7e9a96664',NULL,0,NULL,NULL,0,'push rbp
mov rbp, rsp
mov eax, [rcx+10h]
imul eax, 3
add eax, 5
xor edx, edx
pop rbp
retn',NULL,NULL,NULL,1,0,'4096','[[0]]','2','push rbp
mov rbp, rsp
mov eax, [rcx+10h]
imul eax, 3
add eax, 5
xor edx, edx
pop rbp
retn',NULL,'34','[]','4a12c19ce6ec5a164706609661e3e024',96,'0','[]',0,'4096','[]','0',NULL,NULL,NULL,NULL,'1',0.001);
INSERT INTO "functions" VALUES(2,'func_2','8192',3,2,1,1,28,7,'["push", "mov", "shl", "lea", "sub", "pop", "retn"]','[]',NULL,1,'7',NULL,'func_2','5c1ff2971156140e5aa3a81469a94b4d',NULL,0,NULL,NULL,0,'push rbx
mov ebx, ecx
shl ebx, 4
lea eax, [rbx+rbx*2]
sub eax, 7
...
sub eax, 7
pop rbx
retn',NULL,'33','[]','5150f53416fec79e7ad39280a2eed754',192,'0','[]',0,'8192','[]','0',NULL,NULL,NULL,NULL,'1',0.002);
...
INSERT INTO "sqlite_stat1" VALUES('functions','idx_23','2 1');
INSERT INTO "sqlite_stat1" VALUES('functions','idx_22','2 2');
INSERT INTO "sqlite_stat1" VALUES('functions','idx_21','2 2');
INSERT INTO "sqlite_stat1" VALUES('functions','idx_20','2 1');
INSERT INTO "sqlite_stat1" VALUES('functions','idx_19','2 1');
...
INSERT INTO "sqlite_stat1" VALUES('functions','idx_10','2 2 1');
INSERT INTO "sqlite_stat1" VALUES('functions','idx_9','2 2 2');
INSERT INTO "sqlite_stat1" VALUES('functions','idx_8','2 2');
INSERT INTO "sqlite_stat1" VALUES('functions','idx_7','2 1 1 1');
INSERT INTO "sqlite_stat1" VALUES('functions','idx_6','2 1 1 1');
INSERT INTO "sqlite_stat1" VALUES('functions','idx_5','2 1 1 1 1 1 1 1 1');
INSERT INTO "sqlite_stat1" VALUES('functions','idx_4','2 1 1');
...
INSERT INTO "sqlite_stat1" VALUES('functions','idx_0','2 1');
