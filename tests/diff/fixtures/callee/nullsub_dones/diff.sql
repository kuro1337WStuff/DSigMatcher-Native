...
CREATE TABLE functions (
                          ...
                          microcode_spp text,
                          export_time real);
INSERT INTO "functions" VALUES(1,'hub_fn','4096',12,13,1,1,41,7,'["mov", "mov", "mov"]','[]','int f()',3,'1011',NULL,'hub_fn','hub','  int v1;
  int v2;
  v1 = 1;
  v2 = 2;
  nullsub_7(v2);
...
INSERT INTO "functions" VALUES(2,'nullsub_7','8192',5,7,1,1,42,7,'["mov", "mov", "mov"]','[]','int f()',4,'1013',NULL,'nullsub_7','nullsub','  int v1;
  int v2;
  v1 = 1;
  v2 = 2;
  leaf_new_fn(v1);
...
INSERT INTO "functions" VALUES(3,'leaf_new_fn','12544',6,7,1,1,53,7,'["mov", "mov", "mov"]','[]','int f()',15,'1035',NULL,'leaf_new_fn','9882d05cb24f7fd0d1cd0dcd1b86a8a1','  int v1;
  int v2;
  v1 = 1;
  v2 = 2;
  inner_b(v1);
...
INSERT INTO "program" VALUES(1,'10','{"2": 1, "3": 1}','metapc','n2');
