# Scenario "other_cpu": exp_a with a different processor on the diff side. same_processor_both_databases
# (D:2950-2967) finds no equal program.processor, so is_same_processor is False and find_matches_diffing
# runs only the pseudo-code pass (D:3219-3229). Synthetic data only. Regenerate with
#   python -B tests/diff/fixtures/callee/gen_callee_fixtures.py --diaphora-dir <diaphora-ref> --only other_cpu
#
# The data below is exp_a's (see exp_a/scenario.py for the recorded 03b experiment A).
