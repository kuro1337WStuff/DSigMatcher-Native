...
INSERT INTO "functions" VALUES(2,'beta_new_callee','8448',0,0,1,1,52,7,'["mov", "mov", "mov"]','[]','int f()',14,'1033',NULL,'beta_new_callee','2afd410e2e5b23dad6f18513b2f72d0d','  int v1;
  int v2;
  v1 = 1;
  v2 = 2;
  delta_new_leaf(v1);
