...
INSERT INTO "compilation_unit_functions" VALUES(2,2,6);
CREATE TABLE compilation_units (
                  ...
                  end_ea text);
INSERT INTO "compilation_units" VALUES(1,'cu_null',1,NULL,NULL,NULL,'70500');
INSERT INTO "compilation_units" VALUES(2,'cu_bad',1,NULL,NULL,'zz','70600');
CREATE TABLE constants (
                  id integer primary key,
                  func_id integer not null references functions(id) on delete cascade,
                  constant text not null);
INSERT INTO "constants" VALUES(1,1,'abcdefgh');
INSERT INTO "constants" VALUES(2,4,'plain text');
...
CREATE TABLE functions (
                          ...
                          microcode_spp text,
                          export_time real);
INSERT INTO "functions" VALUES(1,'e_count_null','70100',8,7,1,1,36,9,'["mov", "add", "xor", "cmp", "mov", "add", "xor", "cmp", "retn"]','[]',NULL,1,'17',NULL,'e_count_null','d1a17959d76f74193582d1871434a324',NULL,0,NULL,NULL,0,'mov eax, 115
add ebx, 129
xor ecx, 143
cmp edx, 157
mov eax, 167
...
xor ecx, 195
cmp edx, 209
retn',NULL,NULL,NULL,1,0,'70100','[[0]]','2','mov eax, 115
add ebx, 129
xor ecx, 143
cmp edx, 157
mov eax, 167
...
xor ecx, 195
cmp edx, 209
retn',NULL,'38','[]','e2fee6668252f6fbb632a2e48bbb16e3',100,'0','["abcdefgh"]',NULL,'70100','[]','0',NULL,NULL,NULL,NULL,'1',0.001);
INSERT INTO "functions" VALUES(2,'e_consts_null','70200',8,7,1,1,36,9,'["mov", "add", "xor", "cmp", "mov", "add", "xor", "cmp", "retn"]','[]',NULL,1,'17',NULL,'e_consts_null','b7e1933cf187617b1555938f64318584',NULL,0,NULL,NULL,0,'mov eax, 212
add ebx, 226
xor ecx, 240
cmp edx, 3
mov eax, 13
...
xor ecx, 41
cmp edx, 55
retn',NULL,NULL,NULL,1,0,'70200','[[0]]','2','mov eax, 212
add ebx, 226
xor ecx, 240
cmp edx, 3
mov eax, 13
...
xor ecx, 41
cmp edx, 55
retn',NULL,'38','[]','501308aad8ff31e3b1617b2885780ce4',200,'0',NULL,1,'70200','[]','0',NULL,NULL,NULL,NULL,'1',0.002);
INSERT INTO "functions" VALUES(3,'e_json_bad','70300',8,7,1,1,36,9,'["mov", "add", "xor", "cmp", "mov", "add", "xor", "cmp", "retn"]','[]',NULL,1,'17',NULL,'e_json_bad','dbf0777d8ee5ed609d79de31bbc4d194',NULL,0,NULL,NULL,0,'mov eax, 58
add ebx, 72
xor ecx, 86
cmp edx, 100
mov eax, 110
...
xor ecx, 138
cmp edx, 152
retn',NULL,NULL,NULL,1,0,'70300','[[0]]','2','mov eax, 58
add ebx, 72
xor ecx, 86
cmp edx, 100
mov eax, 110
...
xor ecx, 138
cmp edx, 152
retn',NULL,'38','[]','e46ee8236197cfc912efd57075908cb6',300,'0','["abcdefgh",',1,'70300','[]','0',NULL,NULL,NULL,NULL,'1',0.003);
INSERT INTO "functions" VALUES(4,'e_surrogate','70400',8,7,1,1,36,9,'["mov", "add", "xor", "cmp", "mov", "add", "xor", "cmp", "retn"]','[]',NULL,1,'17',NULL,'e_surrogate','2c7e4bd170d5bbf2e5dc8e9908682f56',NULL,0,NULL,NULL,0,'mov eax, 155
add ebx, 169
xor ecx, 183
cmp edx, 197
mov eax, 207
...
xor ecx, 235
cmp edx, 249
retn',NULL,NULL,NULL,1,0,'70400','[[0]]','2','mov eax, 155
add ebx, 169
xor ecx, 183
cmp edx, 197
mov eax, 207
...
xor ecx, 235
cmp edx, 249
retn',NULL,'38','[]','b4273c926c27ee4f9ab008be22e347bc',400,'0','["\ud800abcdef", "plain text"]',2,'70400','[]','0',NULL,NULL,NULL,NULL,'1',0.004);
INSERT INTO "functions" VALUES(5,'e_cu_null','70500',8,7,1,1,36,9,'["mov", "add", "xor", "cmp", "mov", "add", "xor", "cmp", "retn"]','[]',NULL,1,'17',NULL,'e_cu_null','028903e3758d736899edb784aa6e7e5e',NULL,0,NULL,NULL,0,'mov eax, 1
add ebx, 15
xor ecx, 29
cmp edx, 43
mov eax, 53
...
xor ecx, 81
cmp edx, 95
retn',NULL,NULL,NULL,1,0,'70500','[[0]]','2','mov eax, 1
add ebx, 15
xor ecx, 29
cmp edx, 43
mov eax, 53
...
xor ecx, 81
cmp edx, 95
retn',NULL,'38','[]','978bca8e21811f52c5fbd4f0ee0f697b',500,'0','[]',0,'70500','[]','0',NULL,NULL,NULL,NULL,'1',0.005);
INSERT INTO "functions" VALUES(6,'e_cu_bad','70600',8,7,1,1,36,9,'["mov", "add", "xor", "cmp", "mov", "add", "xor", "cmp", "retn"]','[]',NULL,1,'17',NULL,'e_cu_bad','38dab4e5e030788d159d221db098a322',NULL,0,NULL,NULL,0,'mov eax, 98
add ebx, 112
xor ecx, 126
cmp edx, 140
mov eax, 150
...
xor ecx, 178
cmp edx, 192
retn',NULL,NULL,NULL,1,0,'70600','[[0]]','2','mov eax, 98
add ebx, 112
xor ecx, 126
cmp edx, 140
mov eax, 150
...
xor ecx, 178
cmp edx, 192
retn',NULL,'38','[]','30b64081d586776345160202c74a9d1d',600,'0','[]',0,'70600','[]','0',NULL,NULL,NULL,NULL,'1',0.006);
INSERT INTO "functions" VALUES(7,'e_la_a','1000',6,5,1,1,28,7,'["mov", "add", "xor", "cmp", "mov", "add", "retn"]','[]',NULL,1,'13',NULL,'e_la_a','b4f4dda16fddc088ff4a991c2e7365d5',NULL,0,NULL,NULL,0,'mov eax, 195
add ebx, 209
xor ecx, 223
cmp edx, 237
mov eax, 247
add ebx, 10
retn',NULL,NULL,NULL,1,0,'1000','[[0]]','2','mov eax, 195
add ebx, 209
xor ecx, 223
cmp edx, 237
mov eax, 247
add ebx, 10
retn',NULL,'36','[]','b12588e97ec61aaa690af8522a5763bf',0,'0','[]',0,'1000','[]','0',NULL,NULL,NULL,NULL,'1',0.007);
INSERT INTO "functions" VALUES(8,'sub_2000','2000',8,7,1,1,36,9,'["mov", "add", "xor", "cmp", "mov", "add", "xor", "cmp", "retn"]','[]',NULL,1,'17',NULL,'sub_2000','3a7c0c12e7e059f8cb50d38f68790256',NULL,NULL,NULL,NULL,0,'mov eax, 41
add ebx, 55
xor ecx, 69
cmp edx, 83
mov eax, 93
...
xor ecx, 121
cmp edx, 135
retn',NULL,NULL,NULL,1,0,'2000','[[0]]','2','mov eax, 41
add ebx, 55
xor ecx, 69
cmp edx, 83
mov eax, 93
...
xor ecx, 121
cmp edx, 135
retn',NULL,'38','[]','334147080c0c7fae0baee37799b4f724',0,'0','[]',0,'2000','[]','0',NULL,NULL,NULL,NULL,'1',0.008);
INSERT INTO "functions" VALUES(9,'e_la_b','3000',6,5,1,1,28,7,'["mov", "add", "xor", "cmp", "mov", "add", "retn"]','[]',NULL,1,'13',NULL,'e_la_b','cb8a4cdc4dc505d1197869a5c8cd51a3',NULL,0,NULL,NULL,0,'mov eax, 138
add ebx, 152
xor ecx, 166
cmp edx, 180
mov eax, 190
add ebx, 204
retn',NULL,NULL,NULL,1,0,'3000','[[0]]','2','mov eax, 138
add ebx, 152
xor ecx, 166
cmp edx, 180
mov eax, 190
add ebx, 204
retn',NULL,'36','[]','c1ba7414efe0aacc007315068622dc9d',0,'0','[]',0,'3000','[]','0',NULL,NULL,NULL,NULL,'1',9.000000000000001054e-03);
INSERT INTO "functions" VALUES(10,'e_la_c','4000',6,5,1,1,28,7,'["mov", "add", "xor", "cmp", "mov", "add", "retn"]','[]',NULL,1,'13',NULL,'e_la_c','05d8e3a7facec5386d82a9829c86509a',NULL,0,NULL,NULL,0,'mov eax, 235
add ebx, 249
xor ecx, 12
cmp edx, 26
mov eax, 36
add ebx, 50
retn',NULL,NULL,NULL,1,0,'4000','[[0]]','2','mov eax, 235
add ebx, 249
xor ecx, 12
cmp edx, 26
mov eax, 36
add ebx, 50
retn',NULL,'36','[]','582184cdc25da268a7ecc8e7263c9b90',0,'0','[]',0,'4000','[]','0',NULL,NULL,NULL,NULL,'1',0.01);
INSERT INTO "functions" VALUES(11,NULL,'5000',8,7,1,1,36,9,'["mov", "add", "xor", "cmp", "mov", "add", "xor", "cmp", "retn"]','[]',NULL,1,'17',NULL,NULL,'b0de37e5cfdd30201a01696b45005b49',NULL,0,NULL,NULL,0,'mov eax, 81
add ebx, 95
xor ecx, 109
cmp edx, 123
mov eax, 133
...
xor ecx, 161
cmp edx, 175
retn',NULL,NULL,NULL,1,0,'5000','[[0]]','2','mov eax, 81
add ebx, 95
xor ecx, 109
cmp edx, 123
mov eax, 133
...
xor ecx, 161
cmp edx, 175
retn',NULL,'38','[]','cae02a32de5b28efd7ec39ba0f74fec2',0,'0','[]',0,'5000','[]','0',NULL,NULL,NULL,NULL,'1',0.011);
INSERT INTO "functions" VALUES(12,'e_la_d','6000',6,5,1,1,28,7,'["mov", "add", "xor", "cmp", "mov", "add", "retn"]','[]',NULL,1,'13',NULL,'e_la_d','6a134c1b11ffa384d4e84957b03465d0',NULL,0,NULL,NULL,0,'mov eax, 178
add ebx, 192
xor ecx, 206
cmp edx, 220
mov eax, 230
add ebx, 244
retn',NULL,NULL,NULL,1,0,'6000','[[0]]','2','mov eax, 178
add ebx, 192
xor ecx, 206
cmp edx, 220
mov eax, 230
add ebx, 244
retn',NULL,'36','[]','90ddf4b80905467bc2a2077f96a0bd14',0,'0','[]',0,'6000','[]','0',NULL,NULL,NULL,NULL,'1',0.012);
...
INSERT INTO "sqlite_stat1" VALUES('compilation_unit_functions','idx_40','2 1');
...
INSERT INTO "sqlite_stat1" VALUES('functions','idx_27','12 12 3 3');
INSERT INTO "sqlite_stat1" VALUES('functions','idx_26','12 3 3');
...
INSERT INTO "sqlite_stat1" VALUES('functions','idx_10','12 12 6');
INSERT INTO "sqlite_stat1" VALUES('functions','idx_9','12 6 6');
INSERT INTO "sqlite_stat1" VALUES('functions','idx_8','12 12');
INSERT INTO "sqlite_stat1" VALUES('functions','idx_7','12 6 6 6');
INSERT INTO "sqlite_stat1" VALUES('functions','idx_6','12 6 6 6');
INSERT INTO "sqlite_stat1" VALUES('functions','idx_5','12 6 6 6 6 6 6 6 6');
