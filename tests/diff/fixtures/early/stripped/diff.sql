...
INSERT INTO "functions" VALUES(2,'sub_180001200','6442455552',4,3,1,1,88,22,'["push", "sub", "mov", "loc_180010200:", "lea", "imul", "cmp", "jle", "loc_180010210:", "lea", "imul", "cmp", "jle", "loc_180010220:", "lea", "imul", "cmp", "jle", "mov", "add", "pop", "retn"]','[]',NULL,1,'9',NULL,'sub_180001200','a2b975255cc3f6a4957668e048df540c','int __fastcall Worker_2(int a1)
{
  int v1 = a1 * 4;
  if ( v1 > 66 )
    return v1 - a1;
...
INSERT INTO "functions" VALUES(3,'sub_180001300','6442455808',4,3,1,1,88,22,'["push", "sub", "mov", "loc_180010300:", "lea", "imul", "cmp", "jle", "loc_180010310:", "lea", "imul", "cmp", "jle", "loc_180010320:", "lea", "imul", "cmp", "jle", "mov", "add", "pop", "retn"]','[]',NULL,1,'9',NULL,'sub_180001300','0be19232fe218d1e8ca04a7b54643731','int __fastcall Worker_3(int a1)
{
  int v1 = a1 * 5;
  if ( v1 > 67 )
    return v1 - a1;
...
INSERT INTO "functions" VALUES(4,'sub_180001400','6442456064',4,3,1,1,88,22,'["push", "sub", "mov", "loc_180010400:", "lea", "imul", "cmp", "jle", "loc_180010410:", "lea", "imul", "cmp", "jle", "loc_180010420:", "lea", "imul", "cmp", "jle", "mov", "add", "pop", "retn"]','[]',NULL,1,'9',NULL,'sub_180001400','5d93c5b8108a06fcdb2ef45ae7e9fac4','int __fastcall Worker_4(int a1)
{
  int v1 = a1 * 6;
  if ( v1 > 68 )
    return v1 - a1;
...
INSERT INTO "functions" VALUES(5,'sub_180001500','6442456320',4,3,1,1,88,22,'["push", "sub", "mov", "loc_180010500:", "lea", "imul", "cmp", "jle", "loc_180010510:", "lea", "imul", "cmp", "jle", "loc_180010520:", "lea", "imul", "cmp", "jle", "mov", "add", "pop", "retn"]','[]',NULL,1,'9',NULL,'sub_180001500','92791822d20f2ff210fe4d632f5d8755','int __fastcall Worker_5(int a1)
{
  int v1 = a1 * 7;
  if ( v1 > 69 )
    return v1 - a1;
...
INSERT INTO "functions" VALUES(6,'sub_180001600','6442456576',4,3,1,1,88,22,'["push", "sub", "mov", "loc_180010600:", "lea", "imul", "cmp", "jle", "loc_180010610:", "lea", "imul", "cmp", "jle", "loc_180010620:", "lea", "imul", "cmp", "jle", "mov", "add", "pop", "retn"]','[]',NULL,1,'9',NULL,'sub_180001600','62d52c9a8967f91e502067b7e8571317','int __fastcall Worker_6(int a1)
{
  int v1 = a1 * 8;
  if ( v1 > 70 )
    return v1 - a1;
...
INSERT INTO "functions" VALUES(7,'sub_180001700','6442456832',5,4,1,1,108,27,'["push", "sub", "mov", "loc_180010700:", "lea", "imul", "cmp", "jle", "loc_180010710:", "lea", "imul", "cmp", "jle", "loc_180010720:", "lea", "imul", "cmp", "jle", "loc_180010730:", "lea", "imul", "cmp", "jle", "mov", "add", "pop", "retn"]','[]',NULL,1,'11',NULL,'sub_180001700','5f3cb58fcadbc7de2a390d7b1f3b8383','int __fastcall sub_180001700(int a1)
{
  int v1 = a1 * 9;
  if ( v1 > 71 )
    return v1 - a1;
...
// v2',8,'452f00901f242dba',NULL,0,'push rbx
sub rsp, 20h
mov ebx, ecx
loc_180010700:
lea eax, [rbx+21]
...
add rsp, 20h
pop rbx
retn','int __fastcall sub_180001700(int a1)
{
  int v1 = a1 * 9;
  if ( v1 > 71 )
    return v1 - a1;
...
// v2','35','[]','a01d0c360f0cce898cd26c33900444ae',832,'7.5','[]',0,'5888','[]','0',NULL,NULL,NULL,NULL,'1',0.007);
INSERT INTO "functions" VALUES(8,'sub_180001800','6442457088',4,3,1,1,88,22,'["push", "sub", "mov", "loc_180010800:", "lea", "imul", "cmp", "jle", "loc_180010810:", "lea", "imul", "cmp", "jle", "loc_180010820:", "lea", "imul", "cmp", "jle", "mov", "add", "pop", "retn"]','[]',NULL,1,'9',NULL,'sub_180001800','22a17235db340b5f84048e691265f7ed','int __fastcall Worker_8(int a1)
{
  int v1 = a1 * 10;
  if ( v1 > 72 )
    return v1 - a1;
...
INSERT INTO "functions" VALUES(9,'sub_180001900','6442457344',4,3,1,1,88,22,'["push", "sub", "mov", "loc_180010900:", "lea", "imul", "cmp", "jle", "loc_180010910:", "lea", "imul", "cmp", "jle", "loc_180010920:", "lea", "imul", "cmp", "jle", "mov", "add", "pop", "retn"]','[]',NULL,1,'9',NULL,'sub_180001900','ea611e157d2f0f9483f7c2e5468e1443','int __fastcall Worker_9(int a1)
{
  int v1 = a1 * 11;
  if ( v1 > 73 )
    return v1 - a1;
...
INSERT INTO "functions" VALUES(10,'sub_180001A00','6442457600',4,3,1,1,88,22,'["push", "sub", "mov", "loc_180010A00:", "lea", "imul", "cmp", "jle", "loc_180010A10:", "lea", "imul", "cmp", "jle", "loc_180010A20:", "lea", "imul", "cmp", "jle", "mov", "add", "pop", "retn"]','[]',NULL,1,'9',NULL,'sub_180001A00','129e3da942e967b612ac1428481ae709','int __fastcall Worker_10(int a1)
{
  int v1 = a1 * 12;
  if ( v1 > 74 )
    return v1 - a1;
...
INSERT INTO "functions" VALUES(11,'sub_180001B00','6442457856',4,3,1,1,88,22,'["push", "sub", "mov", "loc_180010B00:", "lea", "imul", "cmp", "jle", "loc_180010B10:", "lea", "imul", "cmp", "jle", "loc_180010B20:", "lea", "imul", "cmp", "jle", "mov", "add", "pop", "retn"]','[]',NULL,1,'9',NULL,'sub_180001B00','b70795ebf2a38713b642e0996bc258f1','int __fastcall Worker_11(int a1)
{
  int v1 = a1 * 13;
  if ( v1 > 75 )
    return v1 - a1;
...
INSERT INTO "functions" VALUES(12,'sub_180001C00','6442458112',4,3,1,1,88,22,'["push", "sub", "mov", "loc_180010C00:", "lea", "imul", "cmp", "jle", "loc_180010C10:", "lea", "imul", "cmp", "jle", "loc_180010C20:", "lea", "imul", "cmp", "jle", "mov", "add", "pop", "retn"]','[]',NULL,1,'9',NULL,'sub_180001C00','edc776ff78dcd525a87acb03e4fede7f','int __fastcall Worker_12(int a1)
{
  int v1 = a1 * 14;
  if ( v1 > 76 )
    return v1 - a1;
...
INSERT INTO "functions" VALUES(13,'sub_180001D00','6442458368',4,3,1,1,88,22,'["push", "sub", "mov", "loc_180010D00:", "lea", "imul", "cmp", "jle", "loc_180010D10:", "lea", "imul", "cmp", "jle", "loc_180010D20:", "lea", "imul", "cmp", "jle", "mov", "add", "pop", "retn"]','[]',NULL,1,'9',NULL,'sub_180001D00','c3c445ceeead429ed27fb2282ca26740','int __fastcall Worker_13(int a1)
{
  int v1 = a1 * 15;
  if ( v1 > 77 )
    return v1 - a1;
...
INSERT INTO "functions" VALUES(14,'sub_180001E00','6442458624',4,3,1,1,88,22,'["push", "sub", "mov", "loc_180010E00:", "lea", "imul", "cmp", "jle", "loc_180010E10:", "lea", "imul", "cmp", "jle", "loc_180010E20:", "lea", "imul", "cmp", "jle", "mov", "add", "pop", "retn"]','[]',NULL,1,'9',NULL,'sub_180001E00','3c415bed40700fd38b8e6f0b5deb3bd0','int __fastcall Worker_14(int a1)
{
  int v1 = a1 * 16;
  if ( v1 > 78 )
    return v1 - a1;
...
INSERT INTO "functions" VALUES(15,'sub_180001F00','6442458880',4,3,1,1,88,22,'["push", "sub", "mov", "loc_180010F00:", "lea", "imul", "cmp", "jle", "loc_180010F10:", "lea", "imul", "cmp", "jle", "loc_180010F20:", "lea", "imul", "cmp", "jle", "mov", "add", "pop", "retn"]','[]',NULL,1,'9',NULL,'sub_180001F00','cb47550ad77af15b054f4619eee3753b','int __fastcall Worker_15(int a1)
{
  int v1 = a1 * 17;
  if ( v1 > 79 )
    return v1 - a1;
...
INSERT INTO "functions" VALUES(16,'sub_180002000','6442459136',4,3,1,1,88,22,'["push", "sub", "mov", "loc_180011000:", "lea", "imul", "cmp", "jle", "loc_180011010:", "lea", "imul", "cmp", "jle", "loc_180011020:", "lea", "imul", "cmp", "jle", "mov", "add", "pop", "retn"]','[]',NULL,1,'9',NULL,'sub_180002000','90dd9643fbdeadcfa305bfbd1006da64','int __fastcall Worker_16(int a1)
{
  int v1 = a1 * 18;
  if ( v1 > 80 )
    return v1 - a1;
...
INSERT INTO "functions" VALUES(17,'sub_180002100','6442459392',4,3,1,1,88,22,'["push", "sub", "mov", "loc_180011100:", "lea", "imul", "cmp", "jle", "loc_180011110:", "lea", "imul", "cmp", "jle", "loc_180011120:", "lea", "imul", "cmp", "jle", "mov", "add", "pop", "retn"]','[]',NULL,1,'9',NULL,'sub_180002100','b9a5a773a47ad04635fbd24b55c9eba8','int __fastcall Worker_17(int a1)
{
  int v1 = a1 * 19;
  if ( v1 > 81 )
    return v1 - a1;
...
INSERT INTO "functions" VALUES(18,'sub_180002200','6442459648',4,3,1,1,88,22,'["push", "sub", "mov", "loc_180011200:", "lea", "imul", "cmp", "jle", "loc_180011210:", "lea", "imul", "cmp", "jle", "loc_180011220:", "lea", "imul", "cmp", "jle", "mov", "add", "pop", "retn"]','[]',NULL,1,'9',NULL,'sub_180002200','8eb70b62d3dfcb1aa236e2541f60a580','int __fastcall Worker_18(int a1)
{
  int v1 = a1 * 20;
  if ( v1 > 82 )
    return v1 - a1;
...
INSERT INTO "functions" VALUES(19,'sub_180002300','6442459904',4,3,1,1,88,22,'["push", "sub", "mov", "loc_180011300:", "lea", "imul", "cmp", "jle", "loc_180011310:", "lea", "imul", "cmp", "jle", "loc_180011320:", "lea", "imul", "cmp", "jle", "mov", "add", "pop", "retn"]','[]',NULL,1,'9',NULL,'sub_180002300','fd1571a89c1974c0bc01a32a3aaa451c','int __fastcall Worker_19(int a1)
{
  int v1 = a1 * 21;
  if ( v1 > 83 )
    return v1 - a1;
...
INSERT INTO "functions" VALUES(20,'sub_180002400','6442460160',2,1,1,1,24,6,'["xor", "cpuid", "rdtsc", "shl", "or", "retn"]','[]',NULL,1,'5',NULL,'sub_180002400','124272bd8892c43fc4b020d9b27cdb83',NULL,0,NULL,NULL,0,'xor eax, eax
cpuid
rdtsc
shl rdx, 20h
or rax, rdx
...
shl rdx, 20h
or rax, rdx
retn',NULL,'32','[]','ed1c8e454664a5b0ebd3e6f8d890f65c',160,'0','[]',0,'9216','[]','0',NULL,NULL,NULL,NULL,'1',0.02);
INSERT INTO "functions" VALUES(21,'helper_20','6442464256',3,2,1,1,68,17,'["push", "sub", "mov", "loc_180011400:", "lea", "imul", "cmp", "jle", "loc_180011410:", "lea", "imul", "cmp", "jle", "mov", "add", "pop", "retn"]','[]',NULL,1,'7',NULL,'helper_20','c22d4f66d9c9be0ca0043e85a1a9217b','int __fastcall helper_20(int a1)
{
  int v1 = a1 * 22;
  if ( v1 > 84 )
    return v1 - a1;
...
add rsp, 20h
pop rbx
retn',NULL,NULL,NULL,1,0,'13312','[[0]]','2','push rbx
sub rsp, 20h
mov ebx, ecx
loc_180011400:
lea eax, [rbx+60]
...
retn','int __fastcall helper_20(int a1)
{
  ...
  if ( v1 > 84 )
    return v1 - a1;
  return v1;
}','33','[]','57e0613546fbfdd3d97eda1252ce1ce7',256,'20.3','[]',0,'13312','[]','0',NULL,NULL,NULL,NULL,'1',0.021);
INSERT INTO "functions" VALUES(22,'sub_180004000','6442467328',2,1,1,1,12,3,'["mov", "nop", "retn"]','[]',NULL,1,'5',NULL,'sub_180004000','729ec864ad6c927e13edc80823933451',NULL,0,NULL,NULL,0,'mov eax, 0BEEFh
nop
retn',NULL,NULL,NULL,1,0,'16384','[[0]]','2','mov eax, 0BEEFh
nop
retn',NULL,'32','[]','4b3f5f7e402c3437134af9846c81362f',328,'0','[]',0,'16384','[]','0',NULL,NULL,NULL,NULL,'1',0.022);
...
INSERT INTO "sqlite_stat1" VALUES('functions','idx_19','22 6');
...
INSERT INTO "sqlite_stat1" VALUES('functions','idx_7','22 6 6 6');
INSERT INTO "sqlite_stat1" VALUES('functions','idx_6','22 5 1 1');
INSERT INTO "sqlite_stat1" VALUES('functions','idx_5','22 6 6 1 1 1 1 1 1');
