...
INSERT INTO "functions" VALUES(13,'ns::f12(void)','6442458112',4,3,1,1,96,24,'["push", "sub", "mov", "loc_180010C00:", "lea", "imul", "cmp", "jle", "loc_180010C10:", "lea", "imul", "cmp", "jle", "loc_180010C20:", "lea", "imul", "cmp", "jle", "xor", "call", "mov", "add", "pop", "retn"]','[]',NULL,1,'9',NULL,'?f12@ns@@YAXXZ','e904ad0082616bc8b90d91b98d61d831','void __fastcall ns::f12(void)(int a1)
{
  g_state = a1 * 14;
  ns::g(0);
}',5,'5a2a2f9e93d39824',NULL,0,'push rbx
sub rsp, 20h
mov ebx, ecx
loc_180010C00:
lea eax, [rbx+36]
...
retn','void __fastcall ns::f12(void)(int a1)
{
  g_state = a1 * 14;
  ns::g(0);
}','34','[]','88b579b5d05501f6316bdc507f17effc',112,'12.4','[]',0,'7168','[]','0',NULL,NULL,NULL,NULL,'1',1.300000000000000113e-02);
...
INSERT INTO "functions" VALUES(19,'ns::f18(void)','6442525184',4,3,1,1,88,22,'["push", "sub", "mov", "loc_180011200:", "lea", "imul", "cmp", "jle", "loc_180011210:", "lea", "imul", "cmp", "jle", "loc_180011220:", "lea", "imul", "cmp", "jle", "mov", "add", "pop", "retn"]','[]',NULL,1,'9',NULL,'?f18@ns@@YAXXZ','8eb70b62d3dfcb1aa236e2541f60a580','void __fastcall ns::f18(void)(int a1)
{
  g_state = a1 * 20;
...
add rsp, 20h
pop rbx
retn',NULL,NULL,NULL,1,0,'74240','[[0]]','2','push rbx
sub rsp, 20h
mov ebx, ecx
loc_180011200:
lea eax, [rbx+54]
...
{
  g_state = a1 * 20;
}','34','[]','3f047a7769a9b4b70b5cb05c8205e8ad',184,'18.4','[]',0,'74240','[]','0',NULL,NULL,NULL,NULL,'1',0.019);
INSERT INTO "functions" VALUES(20,'ns::f19(void)','6442525440',4,3,1,1,88,22,'["push", "sub", "mov", "loc_180011300:", "lea", "imul", "cmp", "jle", "loc_180011310:", "lea", "imul", "cmp", "jle", "loc_180011320:", "lea", "imul", "cmp", "jle", "mov", "add", "pop", "retn"]','[]',NULL,1,'9',NULL,'?f19@ns@@YAXXZ','fd1571a89c1974c0bc01a32a3aaa451c','void __fastcall ns::f19(void)(int a1)
{
  g_state = a1 * 21;
...
add rsp, 20h
pop rbx
retn',NULL,NULL,NULL,1,0,'74496','[[0]]','2','push rbx
sub rsp, 20h
mov ebx, ecx
loc_180011300:
lea eax, [rbx+57]
...
{
  g_state = a1 * 21;
}','34','[]','903b1d7ed5d233ba25e8467ca3b1bba5',440,'19.4','[]',0,'74496','[]','0',NULL,NULL,NULL,NULL,'1',0.02);
...
INSERT INTO "sqlite_stat1" VALUES('functions','idx_9','20 10 10');
