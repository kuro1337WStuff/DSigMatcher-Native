...
const char* const CorpusNewerWin32u =
    R"(C:\Users\Loki\dsig-corpus\win32u\win32u_100261009444\win32u.dll)";
const char* const CorpusAbsentFile = R"(C:\Users\Loki\dsig-corpus\this-file-does-not-exist.dll)";
